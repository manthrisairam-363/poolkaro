      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              Add CarpoolKaro to your home screen
            </div>
            ...
            >
              Faster access + get ride notifications
            </div>
          </div>
        ...
        {expanded && (
          <div style={{ padding: '0 14px 14px' }}>
            ...
            {isIOS && (
              ...
              >
                Note: on iPhone this only works in{' '}
                <b style={{ color: '#aaa' }}>Safari</b>, not Chrome.
                Notifications work once added to the home screen.
              </div>
            )}
          </div>
        )}
